...
# sg = SearchGraph(node_dic.get("61791501"), node_dic.get("6300399610"), 150.0, "maximize")

# sg.generatePaths()
# print(node_dic.get("61791501"), node_dic.get("6300399610"))
...
sg = SearchGraph(node_dic.get("61794329"), node_dic.get("61790472"), 150.0, "maximize")

sg.generatePaths()
print(node_dic.get("61794329"), node_dic.get("61790472"))
