...
#         if (i % 1000 == 0 or i >= len(node_dict)-1):
...
print(dic.get("6302552898").getNeighbors())
addNodesNeighbors(dic, osm_filepath)
print(dic.get("6302552898").getNeighbors().get("10059688294"))
print(len(dic.get("6302552898").getNeighbors()))
# storeDictAsTxt(dic, cur_path + "/AmherstNodesWNeighbors")
# new_dic = loadDictFromTxt(cur_path + "/AmherstNodesWNeighbors")
# print(len(new_dic.get("8388383989").getNeighbors()))